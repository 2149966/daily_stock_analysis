...
# 监管/政策监控相关关键词（用于触发监管监控模式）
REGULATOR_KEYWORDS = {
    'sec', 'pcaob', 'white house', '白宫', '证监会', 'csrc',
    'china securities regulatory commission',
    'us securities and exchange commission', '证监会办公厅',
    '监管', '监管机构', '监管动态'
}
...
## 以下为 analyzer.py 的其余实现（保持原样，省略重复注释以节省篇幅，但实际文件包含全部原有函数）
